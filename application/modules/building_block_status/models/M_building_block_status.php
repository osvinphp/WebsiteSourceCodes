...
class M_building_block_status extends MY_Model
{
    private $objectName;

    public function __construct()
    {
        $this->objectName = 'BuildingBlockStatus';
    }
    ...
    public function getAll()
    {
        ...
        if ($numRows > 1000)
        {
            ...
            for ($i = 1; $i <= $queryLoop; $i++)
            {
                ...
                // Execute the query
                $BuildingBlockStatus = $table->find(true);

                // Merge user array
                $results = array_merge($results, $BuildingBlockStatus);
                
                // Set last createdAt
                $createdAt = end($BuildingBlockStatus)->getCreatedAt();
            }
    ...
    {
        // Create parse user query
        $table = new ParseObject('BuildingBlockStatus', $id);
        $table->fetch();
    ...
    public function insert($data) 
    {
        ...
        $reward = new ParseObject('BuildingBlockStatus');
    ...
    public function update($data) 
    {
        ...
        $reward = new ParseObject('BuildingBlockStatus', $data->id);
    ...
    {
        // Create new parse query
        $reward = new ParseObject('BuildingBlockStatus', $id);
    ...
    {
        $query = new ParseQuery('BuildingBlockStatus');

...
;(function(globals) {
    ...
    var draw = function(cornelius, cohort, container) {
        ...
        function drawRetentionHeader(data) {
            var retentionTh = create('tr');
            var monthLength = data[0].length;
            retentionTh.appendChild(create('th', { text: '', className: '' }));
            retentionTh.appendChild(create('th', { text: 'Retention Rate %', className: '', colSpan: monthLength }));
        ...
        table.appendChild(drawRetentionHeader(cohort));
